const jlt = {
    ...
    itinerary: [
      ...
      {
        subheading: "Little Bali",
        title: "Authentic Indonesian Restaurant in JLT, Dubai",
        image: '/palm-jumeirah.jg',
        details:
          "If you’re searching for authentic Indonesian food in JLT, Dubai, Little Bali is a hidden gem you should definitely visit. Located in Jumeirah Lakes Towers (JLT), this cozy restaurant brings the rich flavors and warm hospitality of Indonesia right to the heart of Dubai. Little Bali is known for serving traditional Indonesian dishes prepared with authentic spices and recipes. From the moment your food arrives, you can immediately smell the aromatic blend of herbs and spices that define Indonesian cuisine.",
      },
      {
      ...
      {
        subheading: "House Of Indonesia",
        title: "A True Representation of Indonesian Culture in JLT, Dubai",
        image: '/palm-jumeirah.jg',
        details:
          "House of Indonesia in Jumeirah Lakes Towers (JLT), Dubai is one of our favorite Indonesian restaurants in the city. If you’re looking for an authentic taste of Indonesia in Dubai, this restaurant is definitely worth visiting. From the moment you step inside, you’ll feel transported to Indonesia. The restaurants interior is beautifully decorated with traditional Indonesian ornaments, cultural artwork, and detailed design elements that reflect the richness of Indonesian heritage. Its not just about the food — its about experiencing Indonesian culture. The menu features a wide variety of traditional Indonesian dishes, prepared with authentic spices and recipes. Whether youre craving flavorful rendang, aromatic nasi goreng, or comforting Indonesian soups, every dish delivers bold, authentic flavors that remind you of home.",
      },
    ],
  };
  export default jlt;