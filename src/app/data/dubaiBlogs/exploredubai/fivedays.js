const fivedays = {
  ...
  itinerary: [
    {
      ...
      details:
        "Palm Jumeirah is a man-made island featuring luxurious real estate, upscale restaurants, and the famous Aquaventure Waterpark at the Atlantis Hotel. Spend the first half of the day at the waterpark, then explore the mall, Etihad Park, and finish with dinner at West Palm Beach.",
    },
    {
      day: "Day 2",
      title: "Dubai Mall and Burj Khalifa",
    ...
    {
      day: "Day 5",
      title: "Exploring JBR, Dubai Marina, and Beyond",
      image: '/jbr.jpg',
      details:
  ...
  note:
    "This website has a dedicated section for Dubai guides. The Emirates are not limited to just Dubai, and this content will be updated as I visit more places.",
};
